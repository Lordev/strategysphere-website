...
export default function PostList({
    ...
    return (
        <section className="container p-6 mx-auto space-y-2 sm:space-y-12 py-40">
            <div className="grid justify-center grid-cols-1 gap-y-10 gap-x-12 sm:grid-cols-2 lg:grid-cols-3">
