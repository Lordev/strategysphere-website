                    ...
                    <div className="container text-center">
                        <div className="mx-auto max-w-[450px]">
                            ...
                            <p className="mx-auto">
                                ...
                                Dicta deserunt similique error eaque harum, recusandae
                                ducimus voluptatum aliquam quod.
                            </p>
                        </div>
                        <div className="flex flex-wrap lg:flex-nowrap gap-8 mt-sm justify-center items-center *:flex *:items-center *:flex-col *:gap-4 2xl:px-40 px-4 *:max-w-80 *:mx-auto">
                            <div>
                                <Image
                                    width={50}
                                    height={50}
                                ...
                                <p>
                                    ...
                                    adipisicing elit. Fugit cumque culpa libero esse
                                    aperiam. Facere voluptatibus quisquam, nesciunt eum,{" "}
                                </p>
                            </div>
                            <div>
                                <Image
                    ...
                    <div className="flex flex-wrap xl:flex-nowrap justify-center text-center xl:*:mt-16 *:mt-12">
                        <div className="2xl:px-20 px-2 text-center">
                            ...
                            <p className="text-muted">
                                Illum cupiditate corrupti expedita non dolores sequi.
                                Facere voluptatibus quisquam, nesciunt eum.
                            </p>
                        </div>
                        <div className="2xl:px-20 px-2 text-center">
                            {/* <Fade triggerOnce={true}> */}
                ...
                <section className="h-full relative  before:bg-earth before:absolute before:bg-cover before:h-full before:w-full before:bg-no-repeat before:left-0 before:-z-20 before:opacity-50">
                    <div className="gap-16 grid xl:grid-cols-2 xl:py-40 py-20">
                        ...
                        <div className="xl:col-start-2 max-xl:mx-auto ">
                            <FadeWrapper
                                fadeProps={{ triggerOnce: true, direction: "right" }}
                            >
                                <Image
                                    src={"/notation.jpg"}
                                    alt="professional advisory"
